...
class ApiEnvironment(
    ...
    suspend fun getLogoutUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.LOGOUT_URL_PROD
    ...
    suspend fun getLoginByEmailUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.LOGIN_BY_EMAIL_URL_PROD
    ...
    suspend fun getLoginByGoogleUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.LOGIN_BY_GOOGLE_URL_PROD
    ...
    suspend fun getLoginByAppleUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.LOGIN_BY_APPLE_URL_PROD
    ...
    suspend fun getLoginByPurchaseTokenUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.LOGIN_BY_PURCHASE_TOKEN_URL_PROD
    ...
    suspend fun getRegisterByEmailUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.REGISTER_URL_PROD
    ...
    suspend fun getCheckRegisteredUsersUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.CHECK_VERIFIED_USER_URL_PROD
    ...
    suspend fun getSendOTPUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.SEND_OTP_URL_PROD
    ...
    suspend fun getVerifyOTPUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.VERIFY_OTP_URL_PROD
    ...
    suspend fun getOsRecommendationUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.OS_RECOMMENDATION_PROD
    ...
    suspend fun getUserDetailUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.USER_DETAIL_URL_PROD
    ...
    suspend fun getUserMembershipUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.USER_MEMBERSHIP_URL_PROD
    ...
    suspend fun getUserHistoryMembershipUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.USER_HISTORY_MEMBERSHIP_URL_PROD
    ...
    suspend fun getForceUpdateUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.FORCE_UPDATE_PROD
    ...
    suspend fun getPurchaseTokenCheckUrl(): String {
        return when (flavors()) {
            FlavorsType.RELEASE_KMP -> ApiConfig.PURCHASE_TOKEN_CHECK_PROD
    ...
    suspend fun flavors(): FlavorsType {
        ...
        return when (flavor.uppercase()) {
            FlavorsConstant.DEBUG_KMP -> FlavorsType.DEBUG_KMP
