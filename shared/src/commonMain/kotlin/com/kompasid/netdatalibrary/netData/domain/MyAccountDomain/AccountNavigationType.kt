...
enum class AccountNavigationType(val value: String, navigationType: NavigationType) {
    ...
    COMPANY_HISTORY("COMPANY_HISTORY", NavigationType.WEBVIEW("https://korporasi.kompas.id/profil/cerita-berdiri/")),
    ABOUT_ORGANIZATION(
        "ABOUT_ORGANIZATION",
    ...
    TERMS_CONDITIONS("TERMS_CONDITIONS", NavigationType.WEBVIEW("https://www.kompas.id/syarat-dan-ketentuan/")),
    CYBER_MEDIA_GUIDELINES("CYBER_MEDIA_GUIDELINES", NavigationType.WEBVIEW("https://www.kompas.id/pedoman-media-siber/")),

    THEME("THEME", NavigationType.NATIVE),
    CHANGE_PASSWORD("CHANGE_PASSWORD", NavigationType.WEBVIEW("https://account.kompas.id/reset-password/send-link")),
