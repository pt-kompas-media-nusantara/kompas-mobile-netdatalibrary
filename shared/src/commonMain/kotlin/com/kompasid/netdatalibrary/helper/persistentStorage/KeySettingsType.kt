...
enum class KeySettingsType(val key: String) {
    ...
    STATE_INSTALL("STATE_INSTALL"), // 0 = kosong, 1 = first install, 2 = update
    APP_VERSION_KOMPAS_ID("APP_VERSION_KOMPAS_ID"),
    APP_VERSION_KOMPAS_ID_LATEST("APP_VERSION_KOMPAS_ID_LATEST"),
