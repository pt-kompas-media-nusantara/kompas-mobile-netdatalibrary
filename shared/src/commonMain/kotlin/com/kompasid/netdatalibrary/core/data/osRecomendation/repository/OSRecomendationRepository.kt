...
import com.kompasid.netdatalibrary.core.data.osRecomendation.dataSource.OSRecomendationDataSource
...
class OSRecomendationRepository(
    ...
    private val osRecomendationDataSource: OSRecomendationDataSource
        ...
        return try {
            when (val result = osRecomendationApiService.osRecommendation()) {
                is ApiResults.Success -> {
                    ...
                    osRecomendationDataSource.save(resultInterceptor)
