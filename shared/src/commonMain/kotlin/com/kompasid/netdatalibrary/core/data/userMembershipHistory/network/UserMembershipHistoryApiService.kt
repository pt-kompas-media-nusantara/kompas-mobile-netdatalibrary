package com.kompasid.netdatalibrary.core.data.userMembershipHistory.network
...
class UserMembershipHistoryApiService(
    private val httpClient: HttpClient,
    private val settingsDataSource: SettingsDataSource
) {

    suspend fun getUserMembershipHistory(): ApiResults<UserMembershipHistoryResponse, NetworkError> {
        try {
            val httpResponse: HttpResponse =
                httpClient.get("https://api.kompas.id/account/api/v2/users/membership") {
            ...
            val response: BaseResponse<UserMembershipHistoryResponse> = httpResponse.body()
