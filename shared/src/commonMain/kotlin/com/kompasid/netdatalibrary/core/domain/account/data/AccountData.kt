...
val settingData =
    AccountModel("ic_setting", "Pengaturan", "Atur fitur untuk akun Anda.", "",
    AccountNavigationType.SETTINGS)
...
val signOutData = AccountModel("ic_sign_out", "Keluar", "Seluruh data akun dan preferensi tersimpan akan terhapus.", "",
    AccountNavigationType.SIGN_OUT)